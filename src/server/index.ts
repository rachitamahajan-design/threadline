...
const api: Record<string, Handler> = {
  ...
  // One route, one hotkey: starts when idle, stops when recording. This is the
  // seam a macOS Shortcut curls — the same key combo does both.
